        ...
        <div class="col">
            <section class="card bg-light">
                ...
                <article class="card-body">
                    <form method="POST" action="<?php echo BASE_URL ?>usuario/editar/<?php echo md5($arrayCad['id']) ?>" enctype="multipart/form-data" autocomplete="off"  name="nFormUsuario" class="<?php echo (isset($arrayErro) && is_array($arrayErro) && !empty($arrayErro)) ? 'was-validated' : ''; ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <figure class="text-center mt-5">
                                    ...
                                    <figcaption class="mt-3">
                                        ...
                                        <input type="hidden" name="nImagem"  value="<?php echo isset($arrayCad['imagem']) ? $arrayCad['imagem'] : null; ?>" id="iImagem-user"/>
                                    </figcaption>
                                </figure>
                        ...
                        <div class="row">
                            <div class="form-group col">
                                <button class="btn btn-success" name="nSalvar" value="Salvar" type="submit" onclick="valida_formUsuarioEdit()"><i class="fa fa-check-circle" aria-hidden="true"></i> Salvar</button>
