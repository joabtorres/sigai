                    ...
                    <article class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="nNumeroProtocolo"  class="form-control" id="iNumeroProtocolo" placeholder="Exemplo: 01380/2020" value="<?php echo!empty($arrayCad['numero_protocolo']) ? $arrayCad['numero_protocolo'] : ''; ?>" required>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <select class="custom-select select2-js" name="nVincula" id="iVincular">
                                    ...
                                    echo '<option value="0" >Não vincular a processo</option>';
