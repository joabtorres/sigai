...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Set-2020 às 16:43
...
INSERT INTO `cofisc_denuncia` (`id`, `protocolo_id`, `usuario_id`, `status`, `tipo_denuncia_id`, `denunciado`, `descricao`, `cidade_id`, `bairro_id`, `endereco`, `latitude`, `longitude`, `denunciante`, `telefone`, `email`) VALUES
(4, 8, 6, 1, 8, 'empresa y', 'descrição da denuncia', 1, 16, '', '-1.2972744798025817', '-47.95016533914795', 'joab torres alencar', '93 992047173', 'joabtorres1508@gmail.com');
...
(3, '2020-09-10 10:22:00', 'Foi realizado o cadastro da denúncia no banco de dados', 1, 4);
...
(8, '2020-09-10', 1, 3, 1, '222', '2016', '556', '2016', '222', '2020', '4f9a9d5c3c600079bfc105749799cbf6');
...
--
-- Estrutura da tabela `cofisc_vistoria_denuncia`
--

CREATE TABLE `cofisc_vistoria_denuncia` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura da tabela `cofisc_vistoria_solicitacao`
--

CREATE TABLE `cofisc_vistoria_solicitacao` (
  `id` int(10) UNSIGNED NOT NULL,
  `data` date DEFAULT NULL,
  `descricao` text DEFAULT NULL,
  `solicitacao_id` int(10) UNSIGNED NOT NULL
...
ALTER TABLE `cofisc_denuncia`
  ...
  ADD KEY `fk_cofisc_denuncia_usuario1` (`usuario_id`);
...
ALTER TABLE `cofisc_solicitacao`
  ...
  ADD KEY `fk_cofisc_solicitacao_usuario1` (`usuario_id`);
...
--
-- Índices para tabela `cofisc_vistoria_denuncia`
--
ALTER TABLE `cofisc_vistoria_denuncia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_cofisc_vistoria_denuncia_cofisc_denuncia1` (`denuncia_id`);

--
-- Índices para tabela `cofisc_vistoria_solicitacao`
--
ALTER TABLE `cofisc_vistoria_solicitacao`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_cofisc_vistoria_solicitacao_cofisc_solicitacao1` (`solicitacao_id`);
...
--
-- AUTO_INCREMENT de tabela `cofisc_vistoria_denuncia`
--
ALTER TABLE `cofisc_vistoria_denuncia`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `cofisc_vistoria_solicitacao`
--
ALTER TABLE `cofisc_vistoria_solicitacao`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `cofisc_denuncia`
  ...
  ADD CONSTRAINT `fk_cofisc_denuncia_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `cofisc_solicitacao`
  ...
  ADD CONSTRAINT `fk_cofisc_solicitacao_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Limitadores para a tabela `cofisc_vistoria_denuncia`
--
ALTER TABLE `cofisc_vistoria_denuncia`
  ADD CONSTRAINT `fk_cofisc_vistoria_denuncia_cofisc_denuncia1` FOREIGN KEY (`denuncia_id`) REFERENCES `cofisc_denuncia` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `cofisc_vistoria_solicitacao`
--
ALTER TABLE `cofisc_vistoria_solicitacao`
  ADD CONSTRAINT `fk_cofisc_vistoria_solicitacao_cofisc_solicitacao1` FOREIGN KEY (`solicitacao_id`) REFERENCES `cofisc_solicitacao` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
